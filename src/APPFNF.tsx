...
import PanelBarNavContainerFNF from "./components/Containers/PanelBarNavContainerFNF";
      ...
      >
        ...
        >
          <ErrorBoundary FallbackComponent={ErrorFallback}>
            ...
            <Router>
              <Switch>
                <Route sensitive={false} path="/" component={LoginFNF} exact />
                <Route
                  sensitive={false}
                  path="/Error"
                  component={NotFound}
                ...
                <PanelBarNavContainerFNF>
                  <Suspense fallback={<Loader />}>
                    ...
                    {loginResult ? (
                      ...
                      <AuthRoute path="/Home" component={MainFNF} exact />
                    )}
                    ...
                    <AuthRoute path="/PR_B0020W_628" component={PR_B0020W_628} exact />
