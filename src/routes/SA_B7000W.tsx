...
import { gridList } from "../store/columns/SA_B7000W_C";
  ...
  const search = () => {
    try {
      if (
        ...
        throw findMessage(messagesData, "SA_B7000W_001");
      } else if (
