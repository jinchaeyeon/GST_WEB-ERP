...
const CustomRadioField = ["drcrdiv"];
...
const AC_B1240W: React.FC = () => {
  ...
  UseMessages("AC_B1240W", setMessagesData);
  ...
  const search = () => {
    try {
      if (
        ...
        throw findMessage(messagesData, "AC_B1240W_001");
      } else if (
        ...
        throw findMessage(messagesData, "AC_B1240W_002");
      } else {
