...
import { gridList } from "../store/columns/SA_B2411W_C";
...
const SA_B2411: React.FC = () => {
  ...
  UseBizComponent(
    "L_BA005, L_BA061,L_BA015,L_BA171,L_BA172,L_BA173",
  ...
  const search = () => {
    try {
      if (
        ...
        throw findMessage(messagesData, "SA_B2411W_001");
      } else if (
