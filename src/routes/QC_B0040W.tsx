...
const numberField = ["qty", "outqty", "useqty","goodqty","badqty","inqty","procseq"];
  ...
  const search = () => {
    try {
      if (
        ...
        convertDateToStr(filters.todt).substring(0, 4) != convertDateToStr(filters.frdt).substring(0, 4)
      ) {
