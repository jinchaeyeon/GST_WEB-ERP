...
const SA_A2300W: React.FC = () => {
  ...
  UseCustomOption("SA_A2300W", setCustomOptionData);
  ...
  UseBizComponent(
    "L_BA015, L_BA005,L_sysUserMaster_001,L_BA061",
    //내수구분, 사용자, 품목계정
    setBizComponentData
  );
