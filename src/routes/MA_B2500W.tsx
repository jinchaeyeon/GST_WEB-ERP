...
const MA_B2500W: React.FC = () => {
  ...
  UseMessages("MA_B2500W", setMessagesData);

  //커스텀 옵션 조회
  const [customOptionData, setCustomOptionData] = React.useState<any>(null);
  UseCustomOption("MA_B2500W", setCustomOptionData);
