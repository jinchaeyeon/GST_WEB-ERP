...
const comboField = ["colorID", "kind1", "custcd"];
...
const CM_A1600W_603: React.FC = () => {
  ...
  UseBizComponent(
    "L_sysUserMaster_001,R_YN,L_APPOINTMENT_COLOR, R_PLANDIV_YN, L_CUST",
    setBizComponentData
  );
  ...
  const fetchTodoGrid = async (todoFilter: any) => {
    ...
    const todoParameters: Iparameters = {
      procedureName: "P_CM_A1600W_603_Q",
                ...
                <tr>
                  ...
                  <td>
                    {bizComponentData !== null && (
                      <BizComponentComboBox
                        name="custcd"
                        value={userFilter.custcd}
                        bizComponentId="L_CUST"
                        bizComponentData={bizComponentData}
                        changeData={filterComboBoxChange}
                        valueField="custcd"
                        textField="custnm"
