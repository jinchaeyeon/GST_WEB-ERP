...
const AC_A0030W: React.FC = () => {
  ...
  UseBizComponent(
    "L_AC023T, R_USEYN, L_AC012, L_AC008, L_AC033, L_BA073, L_AC009, L_AC010, L_AC090, L_AC007, L_AC001, L_AC061",
    setBizComponentData
  );
  ...
  useEffect(() => {
    ...
    if (filters.pgNum > 1 && filters.pgGap == 0) {
                    ...
                    >
                      <SwiperSlide key={0}>
                        ...
                        >
                          ...
                          <FormBoxWrap
                            style={{
                              height: deviceHeight - height2 - height6,
                              overflow: "auto",
                            }} /*67.5*/
                          >
                            <FormBox>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <Grid
                              style={{
                                height: deviceHeight - height3 - height6,
                              }} // 65
                              data={process(
                      ...
                      >
                        ...
                        >
                          <Grid
                            style={{
                              height:
                                deviceHeight - height4 - height5 - height6,
                              overflow: "auto",
                            }}
                            data={process(
            ...
            <GridContainer width={`calc(75% - ${GAP}px)`}>
              ...
              >
                <TabStripTab title="상세정보">
                  ...
                  <FormBoxWrap
                    style={{ height: "41vh", overflow: "auto" }} /*67.5*/
                  >
                    <FormBox>
                      <tbody>
                        <tr>
