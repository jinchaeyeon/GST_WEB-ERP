                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        >
                          ...
                          <Typography sx={{ p: 1 }}>
                            2: 상세 지시 받은 업무 처리 가능, Browser모듈 이해
                            30% 미만
                          </Typography>
                          <Typography sx={{ p: 1 }}>
                          ...
                          <Typography sx={{ p: 1 }}>
                            4: 능동적으로 비 정형적 업무 처리 가능, Browser모듈
                            이해 90% 미만
                          </Typography>
                          <Typography sx={{ p: 1 }}>
                            5: 자체 업무 설계 / 개발 / 추진 가능, Browser모듈
                            이해 90% 이상
                          </Typography>
                          <Typography sx={{ p: 1 }}>
                            6: 당사 제품(S/W, H/W, IaaS-PaaS-SaaS) 이해도 95%
                            이상 이해하며 미래지향적 업무 아이디어 제시
                          </Typography>
                          <Typography sx={{ p: 1 }}>
                          ...
                          <Typography sx={{ p: 1 }}>
                            9: 추가 수익을 낼 수 있는 신 사업 계획 및 추진 가능
                          </Typography>
                          <Typography sx={{ p: 1 }}>
                            10: 의사결정정보를 적극 제공하며, 경영자적 관점에서
                            업무 처리
                          </Typography>
                        </Popover>
                      </td>
                      ...
                      <Grid
                        ...
                        data={process(
                          mainDataResult6.data.map((row) => ({
                            ...row,
                            recdt:
                              row.recdt == "" ? new Date() : toDate(row.recdt),
                      ...
                      <Grid
                        ...
                        data={process(
                          mainDataResult7.data.map((row) => ({
                            ...row,
                            reqdt:
                              row.reqdt == "" ? new Date() : toDate(row.reqdt),
