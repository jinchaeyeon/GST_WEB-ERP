  ...
  useLayoutEffect(() => {
    if (customOptionData !== null) {
      ...
      const handleWindowResize = () => {
        ...
        setMobileHeight(getDeviceHeight(false) - height - height6 - height7);
        setMobileHeight2(getDeviceHeight(false) - height2 - height6 - height7);
        setMobileHeight3(getDeviceHeight(true) - height - height6 - height7);
        setMobileHeight4(getDeviceHeight(true) - height6 - height7);
        setMobileHeight5(getDeviceHeight(true) - height6 - height7);
        setMobileHeight6(
          getDeviceHeight(true) - height2 - height6 - height7 - height7
        );
        setMobileHeight7(
          getDeviceHeight(true) - height2 - height6 - height7 - height7
        );
        ...
        setMobileHeight9(
          getDeviceHeight(true) - height3 - height6 - height7 - height7
        );
        setMobileHeight10(
          getDeviceHeight(true) - height3 - height6 - height7 - height7
        );
        setWebHeight(getDeviceHeight(false) - height - height6 - height7);
        setWebHeight2(getDeviceHeight(false) - height2 - height6 - height7);
        setWebHeight3(getDeviceHeight(true) * 2 - height - height6 - height7);
        setWebHeight4(
          getDeviceHeight(true) * 2 -
            height2 -
            height4 -
            height5 -
            height6 -
        ...
        setWebHeight7(
          getDeviceHeight(true) * 2 - height3 - height6 - height7 - height7
        );
        setWebHeight8(
          getDeviceHeight(true) * 2 - height3 - height6 - height7 - height7
        );
