...
import { gridList } from "../store/columns/MA_A3300W_C_mihyeon";
...
const MA_A3300W_mihyeon: React.FC = () => {
  ...
  UseCustomOption("MA_A3300W_mihyeon", setCustomOptionData);
  ...
  // { sub_code: "", code_name: "" } 형식과 다르면 직접 정의
...
export default MA_A3300W_mihyeon;
