...
const QC_B9020_615W: React.FC = () => {
  ...
  const search = () => {
    try {
      if (
        convertDateToStr(filters.yyyymmdd).substring(0, 4) < "1997" ||
        convertDateToStr(filters.yyyymmdd).substring(6, 8) > "31" ||
        convertDateToStr(filters.yyyymmdd).substring(6, 8) < "01" ||
        convertDateToStr(filters.yyyymmdd).substring(6, 8).length != 2
      ) {
  ...
  const fetchMainGrid = async (filters: any) => {
    ...
    const parameters: Iparameters = {
      ...
      parameters: {
        ...
        "@p_yyyymmdd": convertDateToStr(filters.yyyymmdd),
