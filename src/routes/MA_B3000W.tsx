...
const MA_B3000W: React.FC = () => {
  ...
  UseCustomOption("MA_B3000W", setCustomOptionData);
              ...
              >
                <SwiperSlide key={0}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Grid
                        style={{ height: deviceHeight - height - height }}
                        data={process(
                          gridDataResult.data.map((row) => ({
                            ...row,
                            // person: personListData.find(
                ...
                <SwiperSlide key={1}>
                  ...
                  >
                    ...
                    <Chart
                      style={{
                        height: deviceHeight - height - height,
                        width: "100%",
                      }}
                    >
                      {/* <ChartTitle text="Units sold" /> */}
            ...
            <TabStripTab title="월별">
              <GridContainerWrap flexDirection="column">
                ...
                <GridContainerWrap>
                  <GridContainer
                    width={
                      CLIENT_WIDTH - GNV_WIDTH - GRID_MARGIN - 60 - 600 + "px"
                    }
                  >
                    <Chart>
                      {/* <ChartTitle text="Units sold" /> */}
