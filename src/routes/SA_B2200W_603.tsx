...
import ProjectsWindow from "../components/Windows/SA_B2200W_603_Project_Window";
...
const SA_B2200W_603: React.FC = () => {
  ...
  const fetchMainGrid = async (filters: any) => {
    ...
    const parameters: Iparameters = {
      procedureName: "P_SA_A2000_603_Q",
