...
const AC_B6020W: React.FC = () => {
  ...
  UseMessages("AC_B6020W", setMessagesData);
  ...
  UseCustomOption("AC_B6020W", setCustomOptionData);
  ...
  const fetchMainGrid = async (filters: any) => {
    ...
    const parameters: Iparameters = {
      ...
      parameters: {
        ...
        "@p_stddt": convertDateToStr(filters.stddt),
        "@p_position": "",
      },
    };
  ...
  const search = () => {
    try {
      if (
        ...
        throw findMessage(messagesData, "AC_B6020W_001");
      } else if (
