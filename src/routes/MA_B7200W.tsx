...
const MA_B7200W: React.FC = () => {
  ...
  if (container2?.clientHeight != undefined) {
    height2 = container == undefined ? 0 : container2.clientHeight;
  }
  ...
  const exportExcel = () => {
    if (_export !== null && _export !== undefined) {
      if (tabSelected == 0) {
        ...
        optionsGridOne.sheets[0].title = "품목별기간재고";
        optionsGridOne.sheets[1].title = "입고상세내역";
        optionsGridOne.sheets[2].title = "출고상세내역";
        _export.save(optionsGridOne);
      }
    } else if (_export4 !== null && _export4 !== undefined) {
      if (tabSelected == 1) {
        ...
        optionsGridFour.sheets[0].title = "제공품재고";
        optionsGridFour.sheets[1].title = "입고상세내역";
        optionsGridFour.sheets[2].title = "출고상세내역";
                      ...
                      <Grid
                        ...
                        data={process(
                          detailDataResult3.data.map((row) => ({
                            ...
                            [SELECTED_FIELD]:
                              detailselectedState3[idGetter5(row)],
                          })),
                          detailDataState3
                        )}
                        {...detailDataState3}
                      ...
                      <Grid
                        ...
                        data={process(
                          detailDataResult4.data.map((row) => ({
                            ...
                            [SELECTED_FIELD]:
                              detailselectedState4[idGetter6(row)],
                          })),
                          detailDataState4
                        )}
                        {...detailDataState4}
