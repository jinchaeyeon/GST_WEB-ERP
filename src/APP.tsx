...
const AC_B2020W = lazy(() => import("./routes/AC_B2020W"));
const AC_B2060W = lazy(() => import("./routes/AC_B2060W"));
...
const CM_A4000W = lazy(() => import("./routes/CM_A4000W"));
const CM_A4100W = lazy(() => import("./routes/CM_A4100W"));
const CM_A4500W = lazy(() => import("./routes/CM_A4500W"));
...
const CM_B1160W = lazy(() => import("./routes/CM_B1160W"));
...
const AppInner: React.FC = () => {
  ...
  function link(str: any) {
    if (str == "Home" || str == "" || str == undefined || str == null) {
      ...
      return AC_B2000W;
    } else if (str == "AC_B2020W") {
      return AC_B2020W;
    } else if (str == "AC_B2060W") {
      return AC_B2060W;
      ...
      return CM_A3220W;
    } else if (str == "CM_A4000W") {
      return CM_A4000W;
    } else if (str == "CM_A4100W") {
      return CM_A4100W;
    } else if (str == "CM_A4500W") {
      return CM_A4500W;
              ...
              <Switch>
                ...
                <PanelBarNavContainer>
                  <Suspense fallback={<Loader />}>
                    ...
                    <AuthRoute path="/AC_B2020W" component={AC_B2020W} exact />
                    <AuthRoute path="/AC_B2060W" component={AC_B2060W} exact />
                    ...
                    <AuthRoute path="/CM_A4000W" component={CM_A4000W} exact />
                    <AuthRoute path="/CM_A4100W" component={CM_A4100W} exact />
                    <AuthRoute path="/CM_A4500W" component={CM_A4500W} exact />
                    ...
                    <AuthRoute path="/CM_B1160W" component={CM_B1160W} exact />
