...
import { default as PanelBarNavContainerOLED } from "./components/Containers/PanelBarNavContainerOLED";
      ...
      >
        ...
        >
          <ErrorBoundary FallbackComponent={ErrorFallback}>
            ...
            <Router>
              <Switch>
                <Route sensitive={false} path="/" component={LoginOLED} exact />
                <Route
                  sensitive={false}
                  path="/Error"
                  component={NotFound}
