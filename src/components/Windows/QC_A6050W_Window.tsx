...
const CopyWindow = ({
  ...
  useEffect(() => {
    if (ParaData.outdt != null && permissions.save) {
      fetchTodoGridSaved();
    }
              ...
              <GridContainer>
                ...
                >
                  ...
                  <GridColumn
                    ...
                    width="120px"
                  />
                  <GridColumn field="proccd" title="검사내역" width="120px" />
                  <GridColumn field="itemcd" title="품목코드" width="120px" />
                  <GridColumn field="itemnm" title="품목명" width="150px" />
                  <GridColumn field="person" title="검사담당자" width="120px" />
                  <GridColumn
                    field="extra_field6"
                    title="검사관"
                    width="120px"
