              ...
              <div>
                ...
                <div className="agreement">
                  <div className="textarea">
                    ...
                    <p className="p_txt">
                      이 약관은 한국과학기술원 부설 국가 나노종합기술원(이하
                      "기술원"라 한다)에서 구축하여 운영하는 연구장비정보망
                      서비스(이하 "서비스"라 한다)의 이용조건 및 절차에 관한
                    ...
                    <ul className="ul_none">
                      <li>
                        ① 기술원은 다음 각 호에 해당하는 경우에는 이용신청에
                        대한 승낙을 제한할 수 있으며, 그 사유가 해소될 때까지
                        승낙을 유보할 수 있습니다.
                        <br />
                        ...
                        나. 기술상 지장이 있는 경우
                        <br />
                        다. 기타 기술원의 사정상 필요하다고 인정되는 경우
                      </li>
                      <li>
                        ② 기술원은 다음 각 호의 1에 해당하는 이용계약신청에
                        대하여는 이를 승낙하지 아니할 수도 있습니다.
                        <br />
                        ...
                        신청하였을 때
                        <br />
                        라. 기타 기술원이 정한 이용신청요건이 미비되었을 때
                      </li>
                      <li>
                        {" "}
                        ③ 제1항 또는 제2항에 의하여 이용신청의 승낙을 유보하거나
                        승낙하지 아니하는 경우, 기술원이 이를 이용신청자에게
                        알려야 합니다. 다만, 기술원의 귀책사유 없이
                        이용신청자에게 통지할 수없는 경우는 예외로 합니다.
                      </li>
                    </ul>
                    ...
                    <h5 className="head5 mt_20">제 8 조 (기술원의 의무)</h5>
                    <ul className="ul_none">
                      <li>
                        ① 기술원은 이용고객에게 편의를 제공할 수 있도록 최선의
                        노력을 다하며, 특별한 사정이 없는 한 회원이 서비스
                        이용을 신청한 날에 서비스를 이용할 수 있도록 합니다.
                      </li>
                      <li>
                        ② 기술원은 이 약관에서 정한 바에 따라 계속적이고
                      ...
                      <li>
                        ③ 기술원은 회원으로부터 소정의 절차에 의해 제기되는
                        의견이나 불만이 정당하다고인정할 경우에는 적절한 절차를
                        거처 처리하여야 합니다. 처리 시 일정 기간이 소요될 경우
                        회원에게 그 사유와 처리 일정을 알려주어야 합니다.
                      </li>
                      <li>
                        ④ 기술원은 서비스 제공과 관련하여 취득한 회원의
                      ...
                      <li>
                        ⑤ 제4항의 범위 내에서 기술원은 업무와 관련하여 회원 전체
                        또는 일부의 개인정보에 관한 집합적인 통계 자료를
                        작성하여 이를 사용할 수 있고, 서비스를 통하여 회원의
                        컴퓨터에 쿠키를 전송할 수 있습니다. 이 경우 회원은
                        쿠키의 수신을 거부하거나 쿠키의 수신에 대하여 경고하도록
                    ...
                    <ul className="ul_none">
                      <li>
                        ...
                        또는 주의사항 등 기술원이 공지 혹은 통지하는 사항을
                        준수하여야 하며, 기타 기술원의 업무에 방해되는 행위를
                        하여서는 아니됩니다.
                      </li>
                      <li>
                        ...
                        나. 서비스를 통하여 얻은 정보를 기술원의 사전승낙 없이
                        회원의 이용 이외 목적으로 복제하거나 이를 출판 및 방송
                        등에 사용하거나 제3자에게 제공하는 행위 다. 타인의 특허,
                        상표, 영업비밀, 저작권 등 기타 지적재산권을 침해하는
                        행위 라. 공공질서 및 미풍양속에 위반되는 내용의 정보,
                        문장, 도형 등을 타인에게 유포하는 행위 마. 타인의
                        프라이버시를 침해할 수 있는 내용을 유포하는 행위 바.
                        범죄와 결부된다고 객관적으로 판단되는 행위 사. 기술원의
                        승인을 받지 않고 다른 사용자의 개인정보를 수집 또는
                        저장하는 행위 아. 기타 관계법령에 위배되는 행위
                      </li>
                      <li>
                        ...
                        기술원은 그에 대한 책임을 지지 않습니다.
                      </li>
                      <li>
                        ④ 회원은 기술원의 동의 없이 제3자에게 이용자번호를
                        제공하여 서비스를 이용하게 할 수 없습니다.
                      </li>
                      <li>
                      ...
                      <li>
                        ⑥ 회원은 내용별로 기술원의 서비스 공지사항에 게시하거나
                        별도로 공지한 이용제한 사항을 준수하여야 합니다.
                      </li>
                      <li>
                        ⑦ 회원은 기술원의 사전승낙 없이는 서비스를 이용하여
                        영업활동을 할 수 없으며, 그 영업활동의 결과와 회원이
                        약관에 위반한 영업활동을 하여 발생한 결과에 대하여
                        기술원은 책임을 지지 않습니다. 회원은 이와 같은
                        영업활동으로 기술원이 손해를 입은 경우 기술원에 대하여
                        손해배상 의무를 집니다.
                      </li>
                    </ul>
                    <h5 className="head5 mt_20">제 10 조 (서비스 이용범위)</h5>
                    <p className="p_txt">
                      회원은 기술원의 승낙을 통해 회원가입시 부여된 ID와
                      비밀번호로 서비스를 이용할 수 있으며 기타 기술원이 지정한
                      사이트에서 서비스를 이용할 수 있습니다.
                    </p>
                    <h5 className="head5 mt_20">제 11 조 (정보의 제공)</h5>
                    <p className="p_txt">
                      기술원은 회원이 서비스 이용 중 필요가 있다고 인정되는
                      다양한 정보에 대하여 공지사항이나 전자우편 등의 방법으로
                      회원에게 제공할 수 있습니다.
                    </p>
                    <h5 className="head5 mt_20">제 12 조 (회원의 게시물)</h5>
                    <ul className="ul_none">
                      <li>
                        ① 기술원은 회원이 게시하거나 등록하는 서비스내의
                    ...
                    <ul className="ul_none">
                      <li>
                        ...
                        책임은 게시자에게 있으며, 기술원은 게시자의 동의없이는
                        이를 서비스내 게재 이외에 영리적 목적으로 사용하지
                        않습니다. 다만, 비영리적인 경우에는 그러하지 아니하며
                        또한 기술원은 서비스내의 게재권을 갖습니다.
                      </li>
                      <li>
                        나. 이용고객이 게시한 게시물에 대해 기술원은 게시자의
                        동의 없이 서비스를 이용하여 얻은 정보를 가공, 판매하는
                        행위 등 이용고객에 의해 게재된 자료를 상업적으로 사용할
                        수 없습니다.
                      </li>
                    </ul>
                    ...
                    <ul className="ul_none">
                      <li>
                        ① 서비스의 이용은 기술원의 업무상 또는 기술상 특별한
                        지장이 없는 한 연중무휴 1일 24시간 가능함을 원칙으로
                        합니다. 다만 정기 점검 등의 필요로 기술원이 정한 날이나
                        시간은 그러하지 않습니다.
                      </li>
                      <li>
                        ② 기술원은 서비스를 일정범위로 분할하여 각 범위별로
                        이용가능 시간을 별도로 정할 수 있습니다. 이 경우 사전에
                        그 내용을 공지합니다.
                      </li>
                    </ul>
                    ...
                    <ul className="ul_none">
                      <li>
                        ① 기술원은 다음 각 호에 해당하는 경우 서비스 제공을
                        중지할 수 있습니다. 가. 서비스용 설비의 보수 등 공사로
                        인한 부득이한 경우 나. 전기통신사업법에 규정된
                        기간통신사업자가 전기통신 서비스를 중지했을 경우 다.
                        기타 불가항력적 사유가 있는 경우
                      </li>
                      <li>
                        ② 기술원은 국가비상사태, 정전, 서비스 설비의 장애 또는
                        서비스 이용의 폭주 등으로 정상적인 서비스 이용에 지장이
                        있는 때에는 서비스의 전부 또는 일부를 제한하거나 중지할
                        수 있습니다.
                      </li>
                      <li>
                        ③ 기술원은 제1항 및 제2항의 규정에 의하여 서비스의
                        이용을 제한하거나 중지한 때에는 그 사유 및 제한기간 등을
                        지체없이 회원에게 알려야 합니다.
                      </li>
                    </ul>
                    <h5 className="head5 mt_20">
                    ...
                    <ul className="ul_none">
                      ...
                      <li>
                        ② 기술원은 회원이 다음 각 호에 해당하는 행위를 하였을
                        경우 사전통지 없이 이용계약을 해지하거나 또는 기간을
                        ...
                        경우
                        <br />
                        타. 기술원의 서비스 정보를 이용하여 얻은 정보를 기술원의
                        사전 승낙없이 복제 또는 유통시키거나 상업적으로 이용하는
                        경우
                        <br />
                        파. 회원이 자신의 홈페이지와 게시판에 음란물을
                        게재하거나 음란 사이트 링크하는 경우
                        <br />
                        하. 본 약관을 포함하여 기타 기술원이 정한 이용조건에
                        위반한 경우
                      </li>
                    </ul>
                    ...
                    <p className="p_txt">
                      {" "}
                      기술원은 서비스 요금이 무료인 동안의 서비스 이용과
                      관련하여 기술원의 고의나 과실에 의한 것이 아닌 한 회원에게
                      발생한 어떠한 손해에 관하여도 책임을 지지 않습니다.
                    </p>
                    <h5 className="head5 mt_20"> 제 19 조 (면책조항)</h5>
                    <ul className="ul_none">
                      <li>
                        ① 기술원은 천재지변 또는 이에 준하는 불가항력으로 인하여
                        서비스를 제공할 수 없는 경우에는 서비스 제공에 관한
                        책임이 면제됩니다.
                      </li>
                      <li>
                        ② 기술원은 회원의 귀책사유로 인한 서비스 이용의 장애에
                        대하여 책임을 지지 않습니다.
                      </li>
                      <li>
                        ③ 기술원은 회원이 서비스를 이용하여 기대하는 수익을
                        상실한 것이나 서비스를 통하여 얻은 자료로 인한 손해에
                        관하여 책임을 지지 않습니다.
                      </li>
                      <li>
                        ④ 기술원은 회원이 서비스에 게재한 정보, 자료, 사실의
                        신뢰도, 정확성 등 내용에 관하여는 책임을 지지 않습니다.
                      </li>
                      <li>
                        ⑤ 기술원은 서비스 이용과 관련하여 가입자에게 발생한 손해
                        가운데 가입자의 고의나 과실에 의한 손해에 대하여 책임을
                        지지 않습니다.
                      </li>
                    </ul>
                    ...
                    <p className="p_txt">
                      ...
                      기술원의 본소 소재지를 관할하는 법원을 전속 관할법원으로
                      합니다.
                    </p>
                    <p className="p_txt">[ 부 칙 ]</p>
                    <p className="p_txt">
                      (시행일) 이 약관은 2013년 1월 1일부터 시행합니다.
                    </p>
                  </div>
                  <div className="check">
                    <input
                  ...
                  <div className="agreement">
                    <div className="textarea">
                      ...
                      <p className="p_txt">
                        ...
                        않을 권리를 가지고 있습니다.
                        <br />
                        단, 위 개인정보는 나노종합기술원에서 서비스 제공을 위한
