...
var height4 = 0;
var height5 = 0;
const ItemsMultiWindow_FNF = ({ setVisible, setData, modal = false }: IWindow) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          <GridColumn field="itemtypenm" title="형태" width="200px" />
...
export default ItemsMultiWindow_FNF;
