...
const KendoWindow = ({
  ...
  const handleSubmit = (dataItem: { [name: string]: any }) => {     
    ...
    setParaData((prev) => ({
        ...
        ,fam1   		:filters.fam1   		
        ,fam2   		:filters.fam2   		
        ,regorgdt  		:filters.regorgdt  		
        ,occudate  		:filters.occudate  		
        ,birdt  		:filters.birdt  		
        ,firredt   		:filters.firredt   		 	
        ,rtrdt  		:filters.rtrdt  			
        ,meddate  		:filters.meddate  			
        ,anudate  		:filters.anudate  			
        ,hirdate  		:filters.hirdate  			
        ,exstartdt 		:filters.exstartdt 		 	
        ,exenddt  		:filters.exenddt  
    }));
  }
